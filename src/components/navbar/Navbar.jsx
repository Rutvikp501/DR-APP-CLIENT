...
import { HamburgerIcon, CloseIcon, AddIcon,SettingsIcon ,DeleteIcon ,MoonIcon, SunIcon} from '@chakra-ui/icons';
import {Link} from 'react-router-dom'
import logo from '../../assets/img/logo.jpg'
const Links = [
{ text: 'Dashboard', url: '/home' },
// { text: 'Appoinment', url: '/appoinment' },
{ text: ' Your  Appoinment', url: '/appoinment' },];
